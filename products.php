  ...
  <div class="row">
    <div class="col-sm-4 col-xs-12">
      <div class="panel panel-default text-center">
        ...
        <div class="panel-body" style="height: 558px">
          <img  src="images/box-1.png" style="width: 400px; padding-bottom: 55px;">
    ...
    <div class="col-sm-4 col-xs-12">
      <div class="panel panel-default text-center">
        ...
        <div class="panel-body" style="height: 558px;">
          <img  src="images/box-2.png" style="width: 400px; padding-bottom: 55px;">
          <p><strong>20</strong> Lorem</p>
          <p><strong>15</strong> Ipsum</p>
          <p><strong>5</strong> Dolor</p>
          <p><strong>2</strong> Sit</p>
    ...
    <div class="col-sm-4 col-xs-12">
      <div class="panel panel-default text-center">
        ...
        <div class="panel-body">
          <img  src="images/box-3.png" style="width: 400px; padding-bottom: 10px;">
          <p><strong>20</strong> Lorem</p>
          <p><strong>15</strong> Ipsum</p>
          <p><strong>5</strong> Dolor</p>
          <p><strong>2</strong> Sit</p>
          <p><strong>Endless</strong> Ahmed</p>
        </div>
        <div class="panel-footer">
          <h3>$300</h3>
          <h4>per month</h4>
